...
local layer, parent = torch.class('nn.ApplyBoxesTransform', 'nn.Module')
...
function layer:updateOutput(input)
  ...
  boxes = boxes:view(boxes:size(1), 1, boxes:size(2)):expandAs(trans)
...
function layer:updateGradInput(input, gradOutput)
  ...
  self.gradInput[1] = self.gradInput[1]:sum(2)
